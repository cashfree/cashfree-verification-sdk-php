...
/**
 * NameMatchRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class NameMatchRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NameMatchRequestSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('name_1', $data ?? [], 'JOHN DOE');
        $this->setIfExists('name_2', $data ?? [], 'JOHN DOE');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name_1'] === null) {
            $invalidProperties[] = "'name_1' can't be null";
        }
        if ($this->container['name_2'] === null) {
            $invalidProperties[] = "'name_2' can't be null";
        }
     ...
     * Sets name_1
     *
     * @param string $name_1 It is the name you want to verify.
     *
     * @return self
     */
     ...
     * Sets name_2
     *
     * @param string $name_2 It is the name you want to verify with name_1.
     *
     * @return self
     */
