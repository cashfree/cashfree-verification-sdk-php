...
/**
 * AadhaarOcrRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class AadhaarOcrRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AadhaarOcrRequestSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('back_image', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['front_image'] === null) {
            $invalidProperties[] = "'front_image' can't be null";
        }
     ...
     * Sets back_image
     *
     * @param \SplFileObject|null $back_image It is the scanned image of the back of the aadhaar card. Allowed file type - JPEG/JPG/PNG. The max file size of both the files is 10MB.
     *
     * @return self
     */
    public function setBackImage($back_image)
    {
        if (is_null($back_image)) {
            throw new \InvalidArgumentException('non-nullable back_image cannot be null');
        }
     ...
     * Sets front_image
     *
     * @param \SplFileObject $front_image It is the scanned image of the front of the aadhaar card. Allowed file type - JPEG/JPG/PNG. The max file size of both the files is 10MB.
     *
     * @return self
     */
    public function setFrontImage($front_image)
    {
        if (is_null($front_image)) {
            throw new \InvalidArgumentException('non-nullable front_image cannot be null');
        }
