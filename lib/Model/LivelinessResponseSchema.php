...
/**
 * LivelinessResponseSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class LivelinessResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LivelinessResponseSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('liveliness', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['liveliness'];
    }

    /**
     * Sets liveliness
     *
     * @param bool|null $liveliness It displays the result of the liveliness check.
     *
     * @return self
     */
    public function setLiveliness($liveliness)
    {
        if (is_null($liveliness)) {
            throw new \InvalidArgumentException('non-nullable liveliness cannot be null');
        }
        $this->container['liveliness'] = $liveliness;
     ...
     * Sets score
     *
     * @param float|null $score It displays the score of the liveliness check.
     *
     * @return self
     */
    public function setScore($score)
    {
        ...
        if (($score > 1)) {
            throw new \InvalidArgumentException('invalid value for $score when calling LivelinessResponseSchema., must be smaller than or equal to 1.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling LivelinessResponseSchema., must be bigger than or equal to 0.');
        }
