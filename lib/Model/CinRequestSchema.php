...
/**
 * CinRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class CinRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CinRequestSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cin', $data ?? [], 'U72900KA2015PTC082988');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cin'] === null) {
            $invalidProperties[] = "'cin' can't be null";
        }
     ...
     * Sets cin
     *
     * @param string $cin It is the unique alphanumeric identifier assigned to companies registered under the Ministry of Corporate Affairs, India.
     *
     * @return self
     */
