...
/**
 * PanToGstinRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class PanToGstinRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PanToGstinRequestSchema';
    ...
    */
     ...
     * Sets pan
     *
     * @param string $pan It is the unique 10-character alphanumeric identifier issued by the Income Tax Department.
     *
     * @return self
     */
     ...
     *
     * @param string $verification_id It is the unique ID you create to identify the request. The maximum character limit is 50. Alphanumeric, period (.), hyphen (-), and underscore ( _ ) are allowed.
     *
     * @return self
     */
