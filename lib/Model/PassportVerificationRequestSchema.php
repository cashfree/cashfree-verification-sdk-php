...
/**
 * PassportVerificationRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class PassportVerificationRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PassportVerificationRequestSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('file_number', $data ?? [], 'PA1079341954215');
        $this->setIfExists('dob', $data ?? [], '2007-03-01');
    }
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name It is the name of the passport holder.
     *
     * @return self
     */
     ...
     * Sets file_number
     *
     * @param string $file_number It is the unique alphanumeric code that identifies an individual's passport application.
     *
     * @return self
     */
     ...
     * Sets dob
     *
     * @param string $dob It is the date of birth of the passport holder. The format is YYYY-MM-DD.
     *
     * @return self
     */
