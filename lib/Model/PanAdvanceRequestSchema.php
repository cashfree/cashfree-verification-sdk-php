...
/**
 * PanAdvanceRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class PanAdvanceRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PanAdvanceRequestSchema';
    ...
    {
        $this->setIfExists('pan', $data ?? [], 'AZJPG7110R');
        $this->setIfExists('verification_id', $data ?? [], 'testverificationid');
        $this->setIfExists('name', $data ?? [], 'JOHN SNOW');
    }
    ...
    */
     ...
     * Sets pan
     *
     * @param string $pan It is the unique 10-character alphanumeric identifier of the individual issued by the Income Tax Department. The first 5 should be alphabets followed by 4 numbers and the 10th character should again be an alphabet.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name It is the name of the PAN information holder.
     *
     * @return self
     */
