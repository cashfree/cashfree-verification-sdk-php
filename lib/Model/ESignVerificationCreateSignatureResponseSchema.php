...
/**
 * ESignVerificationCreateSignatureResponseSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ESignVerificationCreateSignatureResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ESignVerificationCreateSignatureResponseSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('signing_link', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets document_id
     *
     * @param int|null $document_id It displays the unique ID created by Cashfree Payments to identify the document. You receive this ID in the response of Upload Document For E-Sign API.
     *
     * @return self
     */
    ...
    {
        return $this->container['signing_link'];
    }

    /**
     * Sets signing_link
     *
     * @param string|null $signing_link It displays the link to proceed with the e-signature of the document.
     *
     * @return self
     */
    public function setSigningLink($signing_link)
    {
        if (is_null($signing_link)) {
            throw new \InvalidArgumentException('non-nullable signing_link cannot be null');
        }
        $this->container['signing_link'] = $signing_link;
