...
/**
 * UpiAdvanceResponseSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class UpiAdvanceResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpiAdvanceResponseSchema';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status It displays the status of the UPI VPA information.
     *
     * @return self
     */
     ...
     * Sets ifsc
     *
     * @param string|null $ifsc It displays the IFSC information associated with the UPI VPA information.
     *
     * @return self
     */
     ...
     * Sets vpa
     *
     * @param string|null $vpa It displays the UPI VPA information.
     *
     * @return self
     */
     ...
     * Sets name_at_bank
     *
     * @param string|null $name_at_bank It displays the name of the account holder as registered in the bank records.
     *
     * @return self
     */
