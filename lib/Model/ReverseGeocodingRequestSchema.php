...
/**
 * ReverseGeocodingRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ReverseGeocodingRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReverseGeocodingRequestSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('latitude', $data ?? [], '12.9274477');
        $this->setIfExists('longitude', $data ?? [], '77.6326542');
    }
    ...
    */
     ...
     * Sets latitude
     *
     * @param string $latitude It is the angular distance expressed in degrees of arc north or south of the equator to specify the location.
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param string $longitude It is the angular distance expressed in degrees of arc east or west of the equator to specify the location.
     *
     * @return self
     */
