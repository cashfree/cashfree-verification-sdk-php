...
/**
 * IpVerificationRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class IpVerificationRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IpVerificationRequestSchema';
    ...
    {
        $this->setIfExists('ip_address', $data ?? [], '1.0.171.255');
    ...
    */
     ...
     * Sets ip_address
     *
     * @param string $ip_address It is the IP address that you need to verify which is assigned to a device connected to a computer network.
     *
     * @return self
     */
