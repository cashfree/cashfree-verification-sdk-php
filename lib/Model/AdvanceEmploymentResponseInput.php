<?php
/**
 * AdvanceEmploymentResponseInput
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvanceEmploymentResponseInput Class Doc Comment
 *
 * @category Class
 ...
 */
class AdvanceEmploymentResponseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdvanceEmploymentResponse_input';
    ...
    */
     ...
     * Sets pan
     *
     * @param string|null $pan It displays the PAN information of the employee.
     *
     * @return self
     */
     ...
     * Sets uan
     *
     * @param string|null $uan It displays the UAN information of the employee.
     *
     * @return self
     */
     ...
     * Sets employer_name
     *
     * @param string|null $employer_name It displays the name of the employer.
     *
     * @return self
     */
