...
/**
 * VehicleRcRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class VehicleRcRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VehicleRcRequestSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vehicle_number'] === null) {
            $invalidProperties[] = "'vehicle_number' can't be null";
        }
     ...
     * Sets vehicle_number
     *
     * @param string $vehicle_number It is the registration number of the vehicle
     *
     * @return self
     */
